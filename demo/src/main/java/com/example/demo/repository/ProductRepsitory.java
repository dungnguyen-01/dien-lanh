...
//    Danh cho product old
    @Query(value= "SELECT * FROM product  WHERE date and product_type=0 order by date desc LIMIT 0,1", nativeQuery=true)
...
// danh cho product new
    ...
    @Query(value= "SELECT * FROM product  WHERE date and product_type=1 order by date desc LIMIT 0,1", nativeQuery=true)
